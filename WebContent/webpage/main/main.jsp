...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	...
	<div region="north" border="false" 
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left" width="750" style="vertical-align: text-bottom">
					<img src="images/sklbanner.gif"/> 
				</td>
						...
						<tr>
							...
							<div style="position: absolute; right: 0px; bottom: 0px;">
								<a href="javascript:void(0);" class="easyui-menubutton"
									menu="#layout_north_kzmbMenu" iconCls="icon-help">控制面板</a>
								<a href="javascript:void(0);" class="easyui-menubutton"
	...
	<div region="west" split="true" href="loginController.do?left"
		title="导航" style="width: 150px; padding: 1px;"></div>
	<!-- 中间-->
	<div id="mainPanle" region="center" style="overflow: hidden;">
		<div id="maintabs" class="easyui-tabs" fit="true" border="false">
			<div class="easyui-tab" title="首页" href="loginController.do?home"
	...
	<div region="south" border="false"
		...
		<div align="center" style="color: #0080FF; padding-top: 2px">
			&copy; 版权所有 光纤通信技术和网络国家重点实验室</span>
		</div>
	</div>
