...
<html>
 <head>
   <title></title>
   <link rel="shortcut icon" href="resources/fc/images/favicon.ico">
  <!--[if lt IE 9]>
...
#login .logo {
 ...
 <body>
  ...
  <div id="login">
   <div class="ribbon" style="background-image:url(plug-in/login/images/etptypelogin.png);"></div>
   <div class="inner">
    <div class="logo">
    <img src="plug-in/login/images/etplogin.png"/>
    </div>
    <div class="formLogin">
     <form name="formLogin" id="formLogin" action="loginController.do?etplogin" check="loginController.do?checketp" method="post">
      <div class="tip">
       <input class="userName" name="qualno" type="text" id="qualno" title="资质证" iscookie="true"  nullmsg="请输入资质证号!"/>
      </div>
      <div class="tip">
      ...
      <div class="loginButton">
       <div style="float: left; margin-left: -9px;">
        ...
        <span class="f_help">是否记住资质证号 ?</span>
       </div>
       <div style="float: right; padding: 3px 0; margin-right: -12px;">
        <div>
         <ul class="uibutton-group">
          <li>
           <a class="uibutton normal" href="javascript:void(0)" id="but_login">登陆</a>
          </li>
          <li>
  ...
  <div id="versionBar">
   <div class="copyright">
    &copy; 版权所有
    <span class="tip"><a href="#" title="信息管理系统">郑州房管局</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="#" title="信息管理系统">河南省道讯信息技术有限公司</a></span>
   </div>
  </div>
  <!-- Link JScript-->
  <script type="text/javascript" src="plug-in/jquery/jquery-1.7.2.min.js"></script>
