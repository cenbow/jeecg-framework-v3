	...
	jq(function() {
		jq('#tt').tree({
			...
			onClick : function(node) {
				jq('#function-panel').panel("refresh", "userController.do?chooseDepart&nodeid=" + node.id);
			}
		});
	});
</script>
 ...
 <body class="easyui-layout">
  ...
  <div id="maintt" region="center" style="overflow: hidden; width: 130px">
   <div class="easyui-panel" style="padding: 10px;" fit="true" border="false" id="function-panel">
    <t:dategrid name="departList" title="按部门选择 " actionUrl="systemController.do?datagridDepart" showRefresh="true" idField="id">
