  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser">
   ...
   <table style="width:600px;" cellpadding="0" cellspacing="1" class="formtable">
    ...
    <tr>
     ...
     <td class="value">
      <input class="inputxt" name="mobilepPone" value="${user.mobilePhone}" datatype="m" errormsg="手机号码不正确!" ignore="ignore">
    ...
    <tr>
     ...
     <td class="value">
      同步
      <input name="activitiSync" type="radio" datatype="need1" <c:if test="${user.activitiSync eq 1}">checked="true"</c:if> value="1">
      不同步
