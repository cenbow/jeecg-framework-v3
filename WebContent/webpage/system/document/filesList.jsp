...
<%@include file="/context/mytags.jsp"%>
 ...
 <div region="center" style="padding:1px;">
  <t:dategrid name="fList" title="文件下载" actionUrl="systemController.do?documentList&typecode=files"  idField="id" fit="true">
   ...
   <t:dgOpenOpt url="commonController.do?openViewFile&fileid={id}&subclassname={subclassname}" title="预览"></t:dgOpenOpt>
