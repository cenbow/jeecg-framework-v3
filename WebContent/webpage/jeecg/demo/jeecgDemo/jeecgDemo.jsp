	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input name="createTime" class="Wdate"
			...
			<tr>
				...
				<td class="value"><t:comboBox
						url="jeecgDemoController.do?combox" name="sex" text="userName"
						id="id"></t:comboBox> <span class="Validform_checktip"></span></td>
			</tr>
			<tr>
				...
				<td class="value"><select id="depId" name="depId" datatype="*">
						<c:forEach items="${departList}" var="depart">
							<option value="${depart.id }"
								<c:if test="${depart.id==jgDemo.depId}">selected="selected"</c:if>>
