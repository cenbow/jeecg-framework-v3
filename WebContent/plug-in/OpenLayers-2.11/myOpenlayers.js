var mapServerIP = "192.168.1.241";// 地图服务器ip地址
...
function init() {
	...
	var bounds = new OpenLayers.Bounds(37379368, 3696032.5, 39522868,
			3965365.75);
	var options = {
		controls : [],
		maxExtent : bounds,
		maxResolution : 560.546875,
		projection : "EPSG:2362",
		units : 'm'
	};
	map = new OpenLayers.Map("map", options);
	// 定义基本图层开始
	tiled = new OpenLayers.Layer.WMS("zz:gongjiao", "http://" + mapServerIP
			+ ":" + mapServerPort + "/geoserver/wms", {
		LAYERS : 'zzgj',
		STYLES : '',
		format : format,
		tiled : true,
